...
ggsave(filename = "./picture/chp9/plot1.png", plot = p[[1]], height = 5, width = 10, dpi = 300)
```
<img src="./picture/chp9/plot1.png" width="100%">
...
ggsave(filename = "./picture/chp9/plot2.png", plot = p[[2]], height = 5, width = 10, dpi = 300)
```
<img src="./picture/chp9/plot2.png" width="100%">
...
ggsave(filename = "./picture/chp9/plot3.png", plot = p[[3]], height = 5, width = 10, dpi = 300)
```
<img src="./picture/chp9/plot3.png" width="100%">
...
ggsave(filename = "./picture/chp9/plot4.png", plot = p[[4]], height = 5, width = 10, dpi = 300)
```
<img src="./picture/chp9/plot4.png" width="100%">
...
ggsave(filename = "./picture/chp9/plot5.png", plot = p[[5]], height = 5, width = 10, dpi = 300)
```
<img src="./picture/chp9/plot5.png" width="95%">
...
ggsave(filename = "./picture/chp9/plot6.png", plot = p[[6]], height = 5, width = 10, dpi = 300)
```
<img src="./picture/chp9/plot6.png" width="100%">
...
ggsave(filename = "./picture/chp9/plot7.png", plot = p[[7]], height = 5, width = 10, dpi = 300)
```
<img src="./picture/chp9/plot7.png" width="100%">
...
ggsave(filename = "./picture/chp9/plot8.png", plot = p[[8]], height = 5, width = 10, dpi = 300)
```
<img src="./picture/chp9/plot8.png" width="95%">
...
ggsave(filename = "./picture/chp9/plot9.png", plot = p[[9]], height = 5, width = 10, dpi = 300)
```
<img src="./picture/chp9/plot9.png" width="100%">
...
ggsave(filename = "./picture/chp9/plot10.png", plot = p[[10]], height = 5, width = 10, dpi = 300)
```
<img src="./picture/chp9/plot10.png" width="100%">
...
```
<div style="display:flex; align-items:center; justify-content:center;">
  <img src="./picture/chp9/palette_popsicle.png" style="width:50%; height: 50%; margin-top: -10px;">
</div>
<br>
<div style="display:flex; align-items:center; justify-content:center; ">
<img src="./picture/chp9/palette_sunset.png" style="width:50%; height: 50%; margin-top: -20px;">
<img src="./picture/chp9/palette_glassdoor.png" style="width:50%; height: 50%; margin-top: -20px;">
</div>
---
...
ggsave(filename = "./picture/chp9/plot11.png", plot = p[[11]], height = 5, width = 10, dpi = 300)
```
<img src="./picture/chp9/plot11.png" width="100%">
...
ggsave(filename = "./picture/chp9/plot12.png", plot = p[[12]], height = 5, width = 10, dpi = 300)
```
<img src="./picture/chp9/plot12.png" width="100%">
...
ggsave(filename = "./picture/chp9/plot13.png", plot = p[[13]], height = 5, width = 10, dpi = 300)
```
<img src="./picture/chp9/plot13.png" width="100%">
...
ggsave(filename = "./picture/chp9/plot14.png", plot = p[[14]], height = 5, width = 10, dpi = 300)
```
<img src="./picture/chp9/plot14.png" width="100%">
...
ggsave(filename = "./picture/chp9/plot15.png", plot = p[[15]], height = 5, width = 10, dpi = 300)
```
<img src="./picture/chp9/plot15.png" width="100%">
...
ggsave(filename = "./picture/chp9/plot.png",plot = last_plot(), height = 7, width = 10, dpi = 300)
```

---
## <h1 lang="en">Layers and Facets Final Plot</h1> 
<img src="./picture/chp9/plot.png" width="100%">
